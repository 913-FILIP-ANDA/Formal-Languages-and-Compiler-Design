...
class Scanner:
    ...
    def isNumberConst(self, token):
        ...
        integer_finite_automaton = FiniteAutomata('D:/Semestrul 5/compilator/lab4/inputFiles/intiger.in')
    ...
    def isIdentifierConst(self, token):
        ...
        #return result is not None
        identifier_finite_automaton = FiniteAutomata('D:/Semestrul 5/compilator/lab4/inputFiles/identifier.in')
